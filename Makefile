...
SOURCES = audioHelper.c animations.c window.c cube.c earth4.c earth6.c credits.c
OBJ = $(SOURCES:.c=.o)
...
EXTRAFILES = COPYING shaders/basic.vs shaders/mix.fs shaders/basic.fs	\
	...
	images/land_ocean_ice_2048_glossmap.png DejaVuSans-Bold.ttf	\
	shaders/credits.vs shaders/credits.fs shaders/titrage.fs
