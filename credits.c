...
static void initme(void) {
  ...
  d = TTF_RenderUTF8_Blended_Wrapped(font, "PROJET- TRACK \n LOÏC LOKO \n15607684 \n Programmation \n Graphique\n Professeur: Monsieur Farès BELHADJ\n Email: \namsi@ai.univ-paris8.fr\n\n Code source fourni par monsieur Farès BELHADJ\n\n Musique: Young Taylor Free Russ  Post Malone Type Beat  in love\n Année:2017/2018", c, 2048);
  if(d == NULL) {
    TTF_CloseFont(font);
